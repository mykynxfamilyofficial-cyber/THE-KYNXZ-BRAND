  ...
  return (
    <>
      ...
      <main id="main-content" role="main" aria-label="Main content" className="relative">
        ...
        <div className="light-home-page relative min-h-[60dvh] pt-20 pb-4 md:pt-24 md:pb-5 lg:min-h-[100dvh] lg:pt-16 lg:pb-5 flex items-center justify-center overflow-hidden">
          <HeroClientFX />
        ...
        {/* Micro-grid pattern overlay — behind content */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 hero-micro-grid"
        />

        {/* Premium grain/noise texture overlay — behind content */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 hero-grain-overlay"
        />
        ...
        <div className="home-hero-content relative text-center px-6 sm:px-12">
          <div
            ...
            className="pointer-events-none absolute inset-0 -z-10 opacity-100 dark:opacity-0 transition-opacity duration-700"
          >
            <div className="absolute left-1/2 top-1/2 h-[800px] w-[1400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle_at_center,#F3F1EC/50,transparent)] blur-2xl" />
          ...
          {/* Dark mode: richer center gold glow behind heading */}
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full
            opacity-0 dark:opacity-100 transition-opacity duration-700
            h-[560px] w-[1200px] bg-[radial-gradient(circle_at_center,rgba(212,168,79,0.22),rgba(212,168,79,0.08),rgba(212,168,79,0.025),transparent)] blur-2xl"
          />
          ...
          <div
            ...
            h-[500px] w-[1100px] bg-[radial-gradient(circle_at_center,#F6F5F2/70,#EDE9E2/45,transparent)] blur-2xl"
          />

          {/* Light mode: soft bronze ambient */}
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full
            opacity-100 dark:opacity-0 transition-opacity duration-700
            h-[650px] w-[1400px] bg-[radial-gradient(circle_at_center,rgba(139,115,85,0.08),rgba(139,115,85,0.025),transparent)] blur-2xl"
          />

          {/* Corner ambient glows — dark mode */}
          <div
            aria-hidden
            className="hero-corner-glow absolute -top-[15%] -left-[8%] rounded-full
            h-[280px] w-[280px] bg-[radial-gradient(circle_at_center,rgba(212,168,79,0.07),rgba(212,168,79,0.02),transparent)] blur-xl"
          />
          <div
            aria-hidden
            className="hero-corner-glow absolute -bottom-[12%] -right-[6%] rounded-full
            h-[220px] w-[220px] bg-[radial-gradient(circle_at_center,rgba(212,168,79,0.05),rgba(212,168,79,0.015),transparent)] blur-xl"
          />
