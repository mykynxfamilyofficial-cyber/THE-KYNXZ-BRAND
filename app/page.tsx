  ...
  return (
    <>
      ...
      <main id="main-content" role="main" aria-label="Main content">
        <div className="light-home-page relative min-h-screen flex items-center justify-center overflow-hidden">
          <HeroClientFX />

        {/* LIGHT THEME: Elegant vignette */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 opacity-0 data-[theme=light]:opacity-100 transition-opacity duration-700"
          data-theme="light"
        >
        ...
        <div className="home-hero-panel-container relative z-10">
          {/* Light-theme-only glassmorphism panel */}
          <div
            className="home-hero-panel absolute inset-0 opacity-0 data-[theme=light]:opacity-100 transition-all duration-700"
            data-theme="light"
          />
          <div className="home-hero-content relative text-center px-6 sm:px-10">
          ...
          {/* LIGHT THEME: Champagne accent glow */}
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/4 rounded-full
            opacity-0 data-[theme=light]:opacity-100 transition-opacity duration-700
            h-[520px] w-[1320px] bg-[radial-gradient(circle_at_center,rgba(212,168,79,0.1),rgba(212,168,79,0.03),transparent)] blur-3xl"
            data-theme="light"
          />
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 -z-20 opacity-0 data-[theme=light]:opacity-45 transition-opacity duration-700 mix-blend-multiply"
            data-theme="light"
          >
          ...
          <h1 className="home-hero-heading relative z-10 mt-6 text-4xl sm:text-6xl md:text-8xl font-semibold tracking-[0.18em] leading-[1.02]
            text-[#111111] dark:text-white/95
            [text-shadow:0_1px_0_rgba(0,0,0,0.08)] dark:[text-shadow:0_2px_0_rgba(255,255,255,0.12)]">
            THE KYNXZ BRAND
          </h1>

          <p className="home-hero-description relative z-10 mt-6 text-base sm:text-lg md:text-xl opacity-85 max-w-2xl mx-auto leading-relaxed
          ...
          <div className="home-hero-actions relative z-10 mt-10 flex flex-col sm:flex-row gap-4 sm:gap-5 items-center justify-center">
            ...
            <a
              ...
              hover:bg-[#EDE9E2] hover:text-[#000000] hover:border-[#000000]/60 hover:shadow-[0_0_0_1px_rgba(0,0,0,0.04),0_20px_60px_rgba(212,168,79,0.18)]

              dark:border-white/20 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 dark:hover:border-white/35"
            >
              <span className="relative mr-2">
                <span className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-[#D4A84F]/30 via-white/20 to-[#D4A84F]/30 blur-[10px]" aria-hidden />
                <span className="relative">Explore Brand</span>
              </span>

              <span
                aria-hidden
                className="h-2 w-2 rounded-full bg-current opacity-80 [box-shadow:0_0_20px_rgba(212,168,79,0.35)]"
              />
            </a>
            ...
            <a
              ...
              hover:bg-[#F6F5F2] hover:shadow-[0_18px_60px_rgba(0,0,0,0.10),0_0_40px_rgba(212,168,79,0.12)]
          ...
          {/* Premium stats row */}
          <div
            className="home-hero-stats relative z-10 mt-12 md:mt-14 lg:mt-16 flex items-center justify-center gap-0"
          >
            <div className="home-hero-stat-item flex flex-col items-center px-6 md:px-10 lg:px-14">
              <span className="home-hero-stat-label text-[10px] md:text-xs tracking-[0.22em] uppercase font-semibold">
                Timeless Design
              </span>
            </div>
      ...
      {/* Scroll indicator */}
      <div className="home-hero-scroll-indicator absolute bottom-8 md:bottom-10 lg:bottom-12 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-3">
        <span className="text-[9px] md:text-[10px] tracking-[0.3em] uppercase font-semibold">
          Scroll to Explore
        </span>
        <div className="relative w-5 h-8 md:w-6 md:h-10 rounded-full border overflow-hidden">
          <div className="absolute top-2 left-1/2 -translate-x-1/2 w-1 h-2 md:w-1.5 md:h-3 rounded-full animate-scroll-mouse" />
        </div>
      </div>
      </div>
